...
| swift-transformers (`Tokenizers`) | 1.3.x | https://github.com/huggingface/swift-transformers | **Apache-2.0** |
| swift-huggingface (`HuggingFace`) | 0.9.x | https://github.com/huggingface/swift-huggingface | **Apache-2.0** |
